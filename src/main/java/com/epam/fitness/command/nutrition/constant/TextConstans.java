package com.epam.fitness.command.nutrition.constant;

/**
 * The type Text constans.
 */
public class TextConstans {
    /**
     ...
     */
    public final static String CLIENT_EXERCISE_PAGE = "/controller?command=show_client_nutrition";
    /**
    ...
    /**
     * The constant NO_ACCESS_PAGE_ERROR.
     */
    public final static String NO_ACCESS_PAGE_ERROR = "no_access_page_error";
}
